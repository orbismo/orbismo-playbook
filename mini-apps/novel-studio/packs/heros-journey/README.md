# Hero's Journey (structure pack)

The 12-stage monomyth cycle — Campbell's arc in Vogler's writer-friendly form — as an adoptable [Novel Studio](../../) template: Ordinary World through the Ordeal to Return with the Elixir, each stage with its act and its job. A natural fit for fantasy, adventure, and any story shaped as a departure and a changed return.
